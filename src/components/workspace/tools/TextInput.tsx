      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-paper border border-ink/5 rounded-lg p-1">
            <button className="p-1.5 hover:bg-surface-low rounded text-muted hover:text-ink transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1" aria-label="Bold text" title="Bold"><Bold size={14} /></button>
            <button className="p-1.5 hover:bg-surface-low rounded text-muted hover:text-ink transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1" aria-label="Italic text" title="Italic"><Italic size={14} /></button>
            <button className="p-1.5 hover:bg-surface-low rounded text-muted hover:text-ink transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1" aria-label="Bulleted list" title="Bulleted list"><List size={14} /></button>
          </div>
          <button
            onClick={handleClear}
