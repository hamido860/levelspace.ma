    ...
    <div className="space-y-6 h-full flex flex-col">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            <button aria-label="Close image" className="absolute top-8 right-8 text-paper hover:text-accent transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1">
              <X size={32} />
            </button>
