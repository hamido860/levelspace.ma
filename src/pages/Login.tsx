...
export const Login: React.FC = () => {
  ...
  return (
    <Layout hideSidebar>
      ...
      <div className="min-h-[100dvh] w-full flex items-center justify-center bg-background p-3 font-sans relative overflow-hidden">
        ...
        <motion.div 
          ...
          className="w-full max-w-[73.5rem] overflow-hidden rounded-[2.5rem] border border-white/20 bg-paper/90 backdrop-blur-xl shadow-2xl shadow-ink/5 relative z-10 grid min-h-[min(832px,calc(100dvh-1.5rem))] lg:grid-cols-[0.8fr_1.2fr]"
        >
          {/* Left Panel: Premium Branding & Info showcase (Hidden on mobile) */}
          <aside className="relative hidden overflow-hidden bg-slate-950 p-11 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="p-8 md:p-14 flex flex-col justify-center space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl font-serif font-medium tracking-tight text-ink">
            ...
            {/* Tab Selector */}
            <div className="flex bg-slate-100 dark:bg-surface-low rounded-2xl p-1 shrink-0">
              <button
                type="button"
            ...
            <form className="space-y-6" onSubmit={handleAuth}>
              <div className="space-y-5">
                <div className="space-y-2">
                  <label className="text-sm font-mono font-bold text-muted uppercase tracking-normal px-1 flex items-center gap-3">
                  ...
                  <input 
                    ...
                    className="w-full h-15 bg-background/50 backdrop-blur-sm border border-ink/5 rounded-2xl px-6 focus:ring-2 focus:ring-accent/40 focus:border-accent/40 outline-none transition-all text-lg font-medium hover:border-ink/10"
                  />
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between px-1">
                    <label className="text-sm font-mono font-bold text-muted uppercase tracking-normal flex items-center gap-3">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="group w-full h-15 bg-ink text-paper rounded-2xl font-semibold text-lg shadow-md shadow-ink/15 hover:shadow-lg hover:shadow-ink/25 hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:hover:translate-y-0 cursor-pointer"
              >
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-sm uppercase tracking-[0.28em] font-mono font-bold">
                <span className="bg-paper px-6 text-muted/50">Or continue with</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                className="h-15 bg-background/50 backdrop-blur-sm border border-ink/5 rounded-2xl flex items-center justify-center gap-3 hover:bg-ink/5 hover:-translate-y-0.5 shadow-sm hover:shadow-md transition-all group cursor-pointer"
              >
                <img src="https://www.google.com/favicon.ico" alt="Google" className="w-4 h-4 grayscale group-hover:grayscale-0 transition-all" />
                <span className="text-base font-bold text-ink uppercase tracking-normal">Google</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-base font-bold text-ink uppercase tracking-normal">Facebook</span>
              </button>
            </div>
          </div>
        </motion.div>
