          ...
          {isAdding ? (
            <div className="flex items-center gap-1 rounded-full border border-ink/10 bg-paper px-3 py-1 shadow-sm">
              <input
                ...
                onBlur={handleAdd}
                placeholder="Add tag..."
                className="w-24 bg-transparent text-[10px] font-medium text-ink outline-none placeholder:text-muted/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1"
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-950 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1"
              title="Add Tag"
            >
