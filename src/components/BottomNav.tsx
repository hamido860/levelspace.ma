      ...
      {navItems.map((item, i) => {
        ...
        return (
          <button 
            ...
            className={`flex flex-col items-center gap-2 transition-all duration-500 group focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 rounded-lg p-1 ${
