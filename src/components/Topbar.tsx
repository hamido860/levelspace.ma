  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="flex items-center gap-3 min-w-0 cursor-pointer hover:opacity-80 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 rounded-lg"
      >
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="flex items-center">
          <button aria-label="Notifications" className="text-muted hover:text-accent p-2 rounded-full hover:bg-ink/5 transition-all relative focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1">
            <Bell size={18} />
