...
type AnalystAction = "insights" | "tasks" | "strategy" | "retry_failed";

const ACTION_PROMPTS: Record<Exclude<AnalystAction, "retry_failed">, string> = {
...
const SYSTEM_PROMPT = `You are an AI analyst for HamidEduApp, a Moroccan educational platform that generates AI lessons for grades 1-12 (Primaire, College, Lycee).
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (err instanceof AiCommandCenterHttpError) {
