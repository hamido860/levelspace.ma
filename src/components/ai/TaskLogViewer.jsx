...
const LOG_META = {
  ...
  warning: { icon: ShieldAlert, className: "bg-amber-50 text-amber-700" },
  ...
  return (
    <section className="ls-card-pad">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <p className="ls-micro-label">Task Logs</p>
          <h3 className="mt-2 ls-card-title">{task?.task_name || "Select a task"}</h3>
        </div>
