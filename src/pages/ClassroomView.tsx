...
export const ClassroomView: React.FC = () => {
  ...
  // ⚡ Bolt: Memoize filtered array to prevent new array references causing cascading re-renders
  ...
  // ⚡ Bolt: Memoize object mapped from Dexie query results for reference stability
