        ...
        {!isCollapsed && (
          <div className="bg-gradient-to-br from-emerald-500/15 via-teal-500/15 to-accent/15 border border-emerald-500/30 dark:from-emerald-500/8 dark:via-teal-500/8 dark:to-accent/8 dark:border-emerald-500/15 p-5 rounded-[1.75rem] relative overflow-hidden shadow-md space-y-4 mt-auto mx-1 select-none">
            ...
            <button
              ...
              className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-white dark:bg-emerald-600 dark:hover:bg-emerald-700 text-xs font-black uppercase tracking-widest rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-center cursor-pointer active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus-visible:ring-offset-emerald-500/15"
            >
              Upgrade
            </button>
          </div>
