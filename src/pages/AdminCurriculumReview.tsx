              ...
              <div className="border-b border-slate-100 dark:border-white/5 pb-5">
                <div className="flex items-center justify-between">
                  ...
                  {selectedItem && (
                    <button
                      onClick={closeDrawer}
                      className="inline-flex items-center gap-1.5 rounded-full border border-ink/10 bg-paper px-3 py-1.5 text-xs font-semibold text-ink transition-all hover:bg-surface-low"
                    >
