    ...
    >
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="flex items-center">
          <button className="text-muted hover:text-accent p-2 rounded-full hover:bg-ink/5 transition-all relative focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1" aria-label="Notifications">
            <Bell size={18} />
