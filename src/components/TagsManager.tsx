          ...
          >
            ...
            {!readonly && (
              <button 
                ...
                className="ml-0.5 rounded-full p-0.5 transition-colors hover:bg-error/10 hover:text-error focus:outline-none focus-visible:ring-2 focus-visible:ring-error"
              >
                <X className="h-3 w-3" />
              </button>
            )}
